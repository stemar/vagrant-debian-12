# Vagrant box Debian 12 LAMP

Make a Vagrant box with Debian 12 LAMP stack, plus configure it for development.

- Host: Linux or Mac.
- Guest: Debian 12, Apache 2.4, MariaDB 10.11, PHP 8.2, Python 3.11, Ruby 3.1, NPM 9.x, Node.js 18.x, Git 2.x.
...
- 64bit Debian 12 virtual machine with virtual 64GB HDD, 3GB RAM and updated LAMP stack from [Bento](https://app.vagrantup.com/bento/boxes/debian-12).
...
You see the "Apache2 Debian Default Page".
